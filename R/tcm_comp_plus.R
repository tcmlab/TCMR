...
#' )
#' tcm_comp_plus(xfbdf.comp)
#' }
tcm_comp_plus <- function(data,
                          start.degree = 180,
  ...
  property <- c("great cold", "cold", "mildly cold", "cool", "even", "mildly warm", "warm", "hot", "great hot", "others")
